...
MODULE_FLAGS = {
    ...
    "analytics": os.environ.get("ENABLE_ANALYTICS", "false").lower() == "true",
    "erp": os.environ.get("ENABLE_ERP", "false").lower() == "true",
    "notifications": os.environ.get("ENABLE_NOTIFICATIONS", "false").lower() == "true",
    ...
    "ads": os.environ.get("ENABLE_ADS", "false").lower() == "true",
    "reports": os.environ.get("ENABLE_REPORTS", "false").lower() == "true",
    "support": os.environ.get("ENABLE_SUPPORT", "false").lower() == "true",
    ...
    "realtime": os.environ.get("ENABLE_REALTIME", "false").lower() == "true",
...
async def lifespan(app: FastAPI):
    ...
    # This ensures FK references (branches.id, companies.id, social_accounts.id) resolve correctly
    try:
