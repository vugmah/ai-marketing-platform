...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("content", sa.Text(), nullable=False),
        sa.Column("media_urls", sa.JSON(), server_default="[]", nullable=False),
        ...
        sa.Column("engagement_stats", sa.JSON(), server_default='{"likes":0,"shares":0,"comments":0,"clicks":0,"impressions":0,"reach":0}', nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("metrics_history", sa.JSON(), server_default="[]", nullable=False),
        sa.Column("created_at", sa.DateTime(), server_default=sa.text("NOW()"), nullable=False),
        sa.Column("updated_at", sa.DateTime(), server_default=sa.text("NOW()"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("handler_config", sa.JSON(), server_default="{}", nullable=False),
        sa.Column("filter_conditions", sa.JSON(), nullable=True),
        sa.Column("is_active", sa.Boolean(), server_default=sa.text("true"), nullable=False),
        sa.Column("retry_policy", sa.JSON(), server_default='{"type":"exponential","max_retries":5,"delay_seconds":2}', nullable=False),
        sa.Column("created_at", sa.DateTime(), server_default=sa.text("NOW()"), nullable=False),
        sa.Column("updated_at", sa.DateTime(), server_default=sa.text("NOW()"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("original_payload", sa.JSON(), server_default="{}", nullable=False),
        sa.Column(
            "resolution_status",
    ...
    op.create_table(
        ...
        sa.Column("limits", sa.JSON(), server_default="{}", nullable=False),
        sa.Column("is_active", sa.Boolean(), server_default=sa.text("true"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("line_items", sa.JSON(), server_default="[]", nullable=False),
        sa.Column("metadata", sa.JSON(), nullable=True),
        sa.Column("created_at", sa.DateTime(), server_default=sa.text("NOW()"), nullable=False),
        sa.Column("updated_at", sa.DateTime(), server_default=sa.text("NOW()"), nullable=False),
